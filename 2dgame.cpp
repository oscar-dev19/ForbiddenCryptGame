...
int main() {
    ...
    // Create a scope for character objects so they get destroyed before we close the audio device
    {
        ...
        // Character objects will be automatically destroyed here when the scope ends
    }
